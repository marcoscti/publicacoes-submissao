...
class Publicacoes_Submissao
{
    ...
    public function register_cpt()
    {
        $labels = array(
            ...
            'menu_name'          => __('Dia das Mães', 'publicacoes-submissao'),
            'name_admin_bar'     => __('Dia das Mães', 'publicacoes-submissao'),
            'add_new'            => __('Adicionar Nova', 'publicacoes-submissao'),
            'add_new_item'       => __('Novo depoimento', 'publicacoes-submissao'),
            ...
            'all_items'          => __('Depoimentos', 'publicacoes-submissao'),
            'search_items'       => __('Buscar publicações', 'publicacoes-submissao'),
            'not_found'          => __('Nenhum publicação encontrada.', 'publicacoes-submissao'),
